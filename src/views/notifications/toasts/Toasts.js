  ...
  const exampleToast = (
    <CToast title="Price Tool">
      <CToastHeader closeButton>
        ...
        <strong className="me-auto">Price Tool</strong>
        ...
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <DocsExample href="components/toast">
              <CToast title="Price Tool" autohide={false} visible={true}>
                <CToastHeader closeButton>
                  <svg
                    className="rounded me-2"
                    width="20"
          ...
          <CCardBody>
            ...
            <DocsExample href="components/toast#translucent">
              <div className="bg-dark p-3">
                <CToast title="s" autohide={false} visible={true}>
                  <CToastHeader closeButton>
                    <svg
                      className="rounded me-2"
                      width="20"
